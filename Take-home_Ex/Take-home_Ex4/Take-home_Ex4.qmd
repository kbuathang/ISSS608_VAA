...
## 4.1 Across different stations for a specific year
...
plot_ly(data = allstations_2021,
        ...
        hoveron = "points+kde",
        line = list(width=1)) %>%
layout(title = list(text = "Mean Temperature by Station in 2021"),
...
ggbetweenstats(data = drop_data,
  ...
  p.adjust.method = "fdr",
  messages = FALSE,
  title = "Mean Temperature by Station in 2021")

```

## 4.2 Specific station across different years
...
## 4.3 Across average of all stations in 2021 to 2023
